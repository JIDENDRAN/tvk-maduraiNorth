var e=class extends HTMLElement{connectedCallback(){let e=window.location.pathname,t=this.hasAttribute(`is-admin`),n=t=>t===`/`&&(e===`/`||e===`/index.html`)||t!==`/`&&e.includes(t)?`active`:``;if(t){this.innerHTML=`
